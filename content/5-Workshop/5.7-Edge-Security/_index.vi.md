...
{{< img src="images/5-Workshop/5.7-Edge-Security/cloudfront-origin.jpg" alt="Cấu hình CloudFront Origin" >}}
...
{{< img src="images/5-Workshop/5.7-Edge-Security/cloudfront-waf.png" alt="Bật bảo mật WAF cho CloudFront" >}}

* Cuộn xuống dưới cùng, kiểm tra lại toàn bộ thông tin tại mục **Review and create** và nhấn **Create distribution**.
{{< img src="images/5-Workshop/5.7-Edge-Security/cloudfront-create.jpg" alt="Xác nhận tạo CloudFront" >}}
