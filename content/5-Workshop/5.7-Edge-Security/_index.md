...
{{< img src="images/5-Workshop/5.7-Edge-Security/cloudfront-origin.jpg" alt="Configure CloudFront Origin" >}}
...
{{< img src="images/5-Workshop/5.7-Edge-Security/cloudfront-waf.png" alt="Enable WAF Security for CloudFront" >}}

* Scroll to the bottom, double-check all information in the **Review and create** section, and click **Create distribution**.
{{< img src="images/5-Workshop/5.7-Edge-Security/cloudfront-create.jpg" alt="Confirm CloudFront Creation" >}}
