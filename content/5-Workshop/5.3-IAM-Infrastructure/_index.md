...
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/hinh-iam-role.jpg" alt="Create IAM Role" >}}
...
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/hinh-vpc-subnet.jpg" alt="Create VPC and Subnets" >}}
...
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/hinh-endpoint-1.jpg" alt="Create VPC Endpoint for Secrets Manager" >}}
...
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/hinh-endpoint-2.jpg" alt="Create VPC Endpoint for CloudWatch" >}}

**Verification Results:** After a few minutes, both Endpoints will successfully transition to the active state.

{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/endpoint_ket_qua.png" alt="Endpoint Verification Results" >}}
...
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/nat-create.jpg" alt="Initialize NAT Gateway" >}}
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/nat-success.png" alt="NAT Gateway Succeeded" >}}
...
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/rtb-private.jpg" alt="Select Private Route Table" >}}
...
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/rtb-save-route.png" alt="Point Route to NAT Gateway" >}}
