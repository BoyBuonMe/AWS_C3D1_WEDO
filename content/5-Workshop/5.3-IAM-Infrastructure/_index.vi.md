...
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/hinh-iam-role.jpg" alt="Tạo IAM Role" >}}
...
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/hinh-vpc-subnet.jpg" alt="Tạo VPC và Subnet cơ bản" >}}
...
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/hinh-endpoint-1.jpg" alt="Tạo VPC Endpoint cho Secrets Manager" >}}
...
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/hinh-endpoint-2.jpg" alt="Tạo VPC Endpoint cho CloudWatch" >}}

**Kết quả nghiệm thu:** Sau vài phút, cả hai Endpoint đều chuyển sang trạng thái hoạt động.

{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/endpoint_ket_qua.png" alt="Kết quả tạo Endpoint" >}}
...
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/nat-create.jpg" alt="Khởi tạo NAT Gateway" >}}
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/nat-success.png" alt="NAT Gateway thành công" >}}
...
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/rtb-private.jpg" alt="Chọn Private Route Table" >}}
...
{{< img src="images/5-Workshop/5.3-IAM-Infrastructure/rtb-save-route.png" alt="Trỏ Route ra NAT Gateway" >}}
